...
class Intagram_TestCases(TestCase):
    def setUp(self):
        self.user1 = User(id=1, username='James',
                          email='jamesone12@gmail.com', password='ppppppp')
        self.user1.save()
        self.profile = Profile(
            user_id=1, bio='i love cheese', profile_pic='images/food.jpg')
        self.profile.save_profile()
        self.my_image = Image(id=1, caption='eating is awesome', owner=self.user1,
                              profile=self.profile, image='media/get.jpg', image_name='muk')
